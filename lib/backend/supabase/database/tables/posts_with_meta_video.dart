...
class PostsWithMetaVideoTable extends SupabaseTable<PostsWithMetaVideoRow> {
  @override
  String get tableName => 'posts_with_meta_video';

  @override
  PostsWithMetaVideoRow createRow(Map<String, dynamic> data) =>
      PostsWithMetaVideoRow(data);
}

class PostsWithMetaVideoRow extends SupabaseDataRow {
  PostsWithMetaVideoRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => PostsWithMetaVideoTable();
