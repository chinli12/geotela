          ...
          child: AppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              title: Padding(
                ...
                child: FutureBuilder<List<ProfilesWithCountsRow>>(
                  future: _model.profilepage(
                    uniqueQueryKey: 'profilekey',
                    requestFn: () => ProfilesWithCountsTable().querySingleRow(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<ProfilesWithCountsRow>
                        columnProfilesWithCountsRowList = snapshot.data!;

                    final columnProfilesWithCountsRow =
                        columnProfilesWithCountsRowList.isNotEmpty
                            ? columnProfilesWithCountsRowList.first
                            : null;
                                  ...
                                  Container(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      imageUrl: valueOrDefault<String>(
                                        columnProfilesWithCountsRow?.avatarUrl,
                          ...
                          if (_model.tab == 1) {
                                    ...
                                    return Container(
                                      child: wrapWithModel(
                                        ...
                                        child: MainpostcardWidget(
                                          key: Key(
                                            'Keyakv_${postIndex.toString()}',
                                          ),
                                          iscommented: false,
                                          post: PostsStruct.maybeFromMap(
                                              postItem)!,
                                          hieg: 200,
                                          like: () async {},
                                        ),
                            ...
                            return FutureBuilder<List<PostsWithMetaVideoRow>>(
                              future: _model
                                ...
                                requestFn: () =>
                                    PostsWithMetaVideoTable().queryRows(
                                  queryFn: (q) => q
                                      .eqOrNull(
                                        'user_id',
                                        currentUserUid,
                                ...
                                try {
                                  ...
                                  _model.requestLastUniqueKey = currentUserUid;
                                } finally {}
                                return result;
                              }),
                              builder: (context, snapshot) {
                                ...
                                return RefreshIndicator(
                                  key: Key('RefreshIndicator_7hn1r3vg'),
                                  onRefresh: () async {
                                    _model.clearUservideCache();
                                    safeSetState(() {
                                      _model.clearUservideCacheKey(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    shrinkWrap: true,
                                    scrollDirection: Axis.vertical,
                                    itemCount: gridViewPostsWithMetaVideoRowList
                                        .length,
