...
class TripdetailsWidget extends StatefulWidget {
  ...
  final TripPlansWithLocationCountsAndCompletedRow? trip;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    fit: BoxFit.cover,
                    image: Image.asset(
                      'assets/images/Frame_1261155274_(3).png',
                    ).image,
                  ),
                  borderRadius: BorderRadius.circular(12.0),
                ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          FutureBuilder<List<TripLocationsRow>>(
                            future: TripLocationsTable().queryRows(
                              queryFn: (q) => q
                                  .eqOrNull(
                                    'trip_plan_id',
                                    widget!.trip?.id,
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<TripLocationsRow>
                                  listViewTripLocationsRowList = snapshot.data!;
                              ...
                              return ListView.separated(
                                ...
                                itemCount: listViewTripLocationsRowList.length,
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 7.0),
                                itemBuilder: (context, listViewIndex) {
                                  final listViewTripLocationsRow =
                                      listViewTripLocationsRowList[
                                          listViewIndex];
                                  return InkWell(
                                    splashColor: Colors.transparent,
                                    focusColor: Colors.transparent,
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      await TripLocationsTable().update(
                                        data: {
                                          'completed': true,
                                        },
                                        matchingRows: (rows) => rows.eqOrNull(
                                          'id',
                                          listViewTripLocationsRow.id,
                                        ),
                                      );
                                      safeSetState(() {});
                                    },
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Icon(
                                                    ...
                                                    color: listViewTripLocationsRow
                                                                .completed ==
                                                            true
                                                        ? FlutterFlowTheme.of(
                                                                context)
                                                        ...
                                                        Expanded(
                                                          child: Text(
                                                            valueOrDefault<
                                                              ...
                                                              listViewTripLocationsRow
                                                                  .address,
                                                              '3600 waston rd st lous mo 63100 usa new olando',
                                                            ),
