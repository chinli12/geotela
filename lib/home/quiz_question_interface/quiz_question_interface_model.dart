...
import 'quiz_question_interface_widget.dart' show QuizQuestionInterfaceWidget;
...
class QuizQuestionInterfaceModel
    extends FlutterFlowModel<QuizQuestionInterfaceWidget> {
  ...
  // Stores action output result for [Backend Call - API (geminiGetQuestions)] action in QuizQuestionInterface widget.
  ApiCallResponse? apiResult7zg;
  // Stores action output result for [Custom Action - parseQuestionsJson] action in QuizQuestionInterface widget.
  List<QuestionStruct>? parsed;
